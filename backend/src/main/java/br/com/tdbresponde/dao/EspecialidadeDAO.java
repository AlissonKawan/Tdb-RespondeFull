...
public class EspecialidadeDAO {
    ...
    public Especialidade buscarPorNome(String nome) {
        String sql = "SELECT ID, NOME, DESCRICAO FROM ESPECIALIDADE WHERE LOWER(NOME) = LOWER(?)";
        Especialidade especialidade = null;
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            throw new DatabaseException("Erro ao buscar especialidade por nome: " + e.getMessage(), e);
        }
