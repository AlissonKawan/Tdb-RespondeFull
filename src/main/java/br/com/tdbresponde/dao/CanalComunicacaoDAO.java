...
public class CanalComunicacaoDAO {
    ...
    public void inserir(CanalComunicacao canal) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            throw new DatabaseException("Erro ao inserir canal: " + e.getMessage(), e);
        }
    }
    ...
    public CanalComunicacao buscarPorId(int id) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            throw new DatabaseException("Erro ao buscar canal: " + e.getMessage(), e);
        }
    ...
    public List<CanalComunicacao> buscarTodos() {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            throw new DatabaseException("Erro ao listar canais: " + e.getMessage(), e);
        }
    ...
    public void atualizar(CanalComunicacao canal) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            throw new DatabaseException("Erro ao atualizar canal: " + e.getMessage(), e);
        }
    }
    ...
    public void excluir(int id) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            throw new DatabaseException("Erro ao excluir canal: " + e.getMessage(), e);
        }
    }
}